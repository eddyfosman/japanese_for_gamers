...
function OnGUI(){
	...
	if(showGui && !showError && s <= textLength){
		...
		GUI.Label (Rect (Screen.width /2 - 263, Screen.height - 290, 500, 200), showText2 , textStyle);
		GUI.Label (Rect (Screen.width /2 - 263, Screen.height - 260, 500, 200), showText3 , textStyle);
		GUI.Label (Rect (Screen.width /2 - 263, Screen.height - 230, 500, 200), showText4 , textStyle);
